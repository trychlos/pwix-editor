(function ($) {
    ...
    $.extend(true, $.trumbowyg, {
        langs: {
            ...
            en: {
                ...
                minus_title: 'Decrease size',
                plus_title: 'Increase size'
            },
            az: {
            ...
            fr: {
                ...
                minus_title: 'Diminuer la taille',
                plus_title: 'Augmenter la taille'
            },
            hu: {
                fontsize: 'Betű méret',
                fontsizes: {
        ...
        plugins: {
            fontsize: {
                init: function (trumbowyg) {
                    ...
                    trumbowyg.addBtnDef('fontsize_custom2', sizeCustomButton(trumbowyg));
                    trumbowyg.addBtnDef('fontsize_minus', sizeMinusButton(trumbowyg));
                    trumbowyg.addBtnDef('fontsize_plus', sizePlusButton(trumbowyg));
                }
            }
        }
    });
    ...
    function getFontSize(trumbowyg) {
        ...
        let node = docSelection.focusNode;
    ...
    function setFontSize(trumbowyg, size) {
        ...
        // Also remove empty <span> elements
        $(trumbowyg.range.startContainer.parentElement).find('span:not([style])').contents().unwrap();
    ...
    function sizeCustomButton(trumbowyg) {
        var btnDef = {
            fn: function () {
                trumbowyg.openModalInsert(trumbowyg.lang.fontCustomSize.title,
                    {
            ...
            ico: 'fontsize',
            title: trumbowyg.lang.fontsizes.custom
        }

        return btnDef;
    }

    function sizeMinusButton(trumbowyg) {
        var btnDef = {
            fn: function () {
                const size = parseInt( getFontSize( trumbowyg ));
                const tick = parseInt( parseInt( size ) / 10 ) / 2 + 0.5;
                setFontSize( trumbowyg, size > tick ? ( size-tick )+'px' : '1em' );
            },
            html: function () {
                return '<img src="/packages/pwix_editor/src/client/third-party/js/trumbowyg/plugins/fontsize/ui/icons/fontsize-minus.svg" width="20px" />'
            },
            title: trumbowyg.lang.minus_title
        }

        return btnDef;
    }

    function sizePlusButton(trumbowyg) {
        var btnDef = {
            fn: function () {
                const size = parseInt( getFontSize( trumbowyg ));
                const tick = parseInt( parseInt( size ) / 10 ) / 2 + 0.5;
                const newsize = size+tick;
                setFontSize( trumbowyg, newsize+'px' );
            },
            html: function () {
                return '<img src="/packages/pwix_editor/src/client/third-party/js/trumbowyg/plugins/fontsize/ui/icons/fontsize-plus.svg" width="18px" />'
            },
            title: trumbowyg.lang.plus_title
        }
